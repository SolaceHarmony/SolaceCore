...
import ai.solace.core.WorkflowManager
...
class WorkflowBuilder(private val scope: CoroutineScope) {
    ...
    /**
     * Builds a `WorkflowManager` instance using the provided actors and connections.
     *
     * @return A configured `WorkflowManager` instance with all the specified actors and their connections.
     */
