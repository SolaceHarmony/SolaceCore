...
/**
 * Tests for the TransactionalInMemoryStorage class.
 */
class TransactionalInMemoryStorageTest {
    private lateinit var storage: TransactionalInMemoryStorage<String, String>

    @BeforeTest
    fun setup() {
        storage = TransactionalInMemoryStorage()
    }
