package io.github.solaceharmony.core.integration

import io.github.solaceharmony.core.actor.Actor
import io.github.solaceharmony.core.workflow.WorkflowManager
...
class PortCommunicationIntegrationTest {
    ...
    private class ProducerActor(id: String = "producer") : Actor(id = id, name = "Producer") {
        private var outputPort: io.github.solaceharmony.core.kernel.channels.ports.Port<String>? = null
    ...
    private class ConsumerActor(id: String = "consumer") : Actor(id = id, name = "Consumer") {
        private var inputPort: io.github.solaceharmony.core.kernel.channels.ports.Port<String>? = null
