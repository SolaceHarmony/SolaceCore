package io.github.solaceharmony.core.util
...
class LoggerProviderTest {
    ...
    fun testGetLoggerByClass() {
        ...
        assertEquals("io.github.solaceharmony.core.util.LoggerProviderTest", logger.name)
    }
    ...
    fun testLoggerExtensionProperty() {
        ...
        assertEquals("io.github.solaceharmony.core.util.LoggerProviderTest\$TestObject", logger.name)
    }
