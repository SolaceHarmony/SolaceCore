package io.github.solaceharmony.core.workflow

import io.github.solaceharmony.core.actor.builder.buildActorNetwork
import io.github.solaceharmony.core.actor.examples.Filter
import io.github.solaceharmony.core.actor.examples.TextProcessor
...
class WorkflowExample {
    ...
    fun textProcessingWorkflowExample() = runBlocking {
        ...
        whitespaceRemover.getPort(TextProcessor.OUTPUT_PORT, String::class)
