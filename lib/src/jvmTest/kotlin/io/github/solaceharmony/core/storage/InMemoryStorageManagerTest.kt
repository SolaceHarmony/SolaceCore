...
class InMemoryStorageManagerTest {
    ...
    fun testGetActorStateStorage() = runBlocking {
        ...
        val state = io.github.solaceharmony.core.actor.ActorState.Running
    ...
    fun testClearAll() = runBlocking {
        ...
        val actorStateStorage = storageManager.getActorStateStorage()
        actorStateStorage.setActorState("test-actor", io.github.solaceharmony.core.actor.ActorState.Running)
