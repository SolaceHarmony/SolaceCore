...
- [Mouth Tool Technical Spec](Mouth-Tool-Technical-Spec): formal Addendum B multimodal expression pipeline specification.
- [Supervisor AI](Supervisor-AI): drafts content and authorizes speech.
- [Multimodal Nudging](Multimodal-Nudging): supplies the perception cues used by v2.
- [Zoom Levels](Zoom-Levels): controls response detail and framing.
