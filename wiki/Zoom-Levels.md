...
- [Zoom Level Technical Spec](Zoom-Level-Technical-Spec): formal Addendum C specification for the zoom mechanism.
- [Voice & Mouth Tool](Voice-and-Mouth-Tool): response framing reads the active zoom level.
- [Supervisor AI](Supervisor-AI): owns the policy decision for focus shifts.
