...
- [Kernel Module Architecture](Kernel-Module-Architecture): architecture-overview kernel module framing.
- [Kernel Channel System](Kernel-Channel-System): channel-system abstractions, port roles, and class relationships.
- [Kernel Port Implementations and Exceptions](Kernel-Port-Implementations-and-Exceptions): concrete port classes, protocol adapters, and exception model.
- [Kernel Port Usage Example](Kernel-Port-Usage-Example): basic `BidirectionalPort` connection example.
- [Kernel Future Enhancements](Kernel-Future-Enhancements): channel-system improvement backlog.
- [Kernel Testing Strategy](Kernel-Testing-Strategy): target unit, integration, property, and performance tests.
