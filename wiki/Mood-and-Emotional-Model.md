...
- [Mood Module Implementation](Mood-Module-Implementation): shipped `core.mood` cue surface, advisor contract, and lexical baseline.
- [Supervisor Emotional Model Integration](Supervisor-Emotional-Model-Integration): older executive-emotional integration sketch.
- [Inference Cube](Inference-Cube): liquid layer that will eventually integrate affective signatures.
- [Memory & Reflection](Memory-and-Reflection): narrative substrate where mood-weighted entries land.
